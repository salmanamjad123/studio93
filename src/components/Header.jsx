...
const Header = () => {
    return (
        <>
            <div className="flex " style={{ backgroundColor: 'var(--Primary-Colour, #3A0CA3)' }}>
                <div className="container mx-auto py-2 " style={{ width: "90%" }}>
                    <div className=" flex justify-between items-center">

                        <h1 className="flex text-white items-center font-normal text-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="18" viewBox="0 0 14 18" fill="none">
                                ...
                                <path d="M7 8.2001C7.41422 8.2001 7.75 7.84194 7.75 7.4001C7.75 6.95827 7.41422 6.6001 7 6.6001C6.58578 6.6001 6.25 6.95827 6.25 7.4001C6.25 7.84194 6.58578 8.2001 7 8.2001Z" fill="#2B2B2B" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            <span className="mx-2">Rezilla, 18 Grattan St, Brooklyn </span>
                        </h1>
                        <h1 className="flex text-white items-center font-normal text-sm">
                            ...
                            <span className="ml-2 mr-6">+1 206-214-229 </span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="13" viewBox="0 0 18 13" fill="none">
                                <path d="M5 4.2002L9 7.00019L13 4.2002" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <span className="mx-2">support@rezilla.com </span>
                        </h1>
                    </div>
                </div>
            </div>
